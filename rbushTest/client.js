...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../common/rbush"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const rbush_1 = require("../../common/rbush");
    // HTML
    ...
    // FPS INFO
    let now, fps = 0, lastFrame = new Date, fpsSmoothing = 50;
    // RTREE
    let tree;
    let elements;
    let count = 1000;
...
},{"../../common/rbush":2}],2:[function(require,module,exports){
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        var v = factory(require, exports);
        if (v !== undefined) module.exports = v;
    ...
    function multiSelect(arr, left, right, n, compare) {
        ...
        while (stack.length) {
            ...
            partialSort(arr, mid, left, right, compare);
