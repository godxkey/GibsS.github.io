...
(function (dependencies, factory) {
    ...
    var body_1 = require("./model/body");
    exports.Rect = body_1.Rect;
    exports.Line = body_1.Line;
    exports.Grid = body_1.Grid;
    exports.Body = body_1.Body;
    exports.EMPTY = body_1.EMPTY;
    exports.BLOCK_TILE = body_1.BLOCK_TILE;
    exports.DOWN_ONEWAY = body_1.DOWN_ONEWAY;
    exports.UP_ONEWAY = body_1.UP_ONEWAY;
    exports.LEFT_ONEWAY = body_1.LEFT_ONEWAY;
    exports.RIGHT_ONEWAY = body_1.RIGHT_ONEWAY;
    var enums_1 = require("./model/enums");
    exports.LayerCollisionRule = enums_1.LayerCollisionRule;
    exports.Direction = enums_1.Direction;
    exports.ParentType = enums_1.ParentType;
    exports.BodyType = enums_1.BodyType;
    const world_2 = require("./model/world");
    const enums_2 = require("./model/enums");
    if (typeof window !== "undefined") {
        window.createWorld = world_2.createWorld;
        window.LayerCollisionRule = enums_2.LayerCollisionRule;
        window.Direction = enums_2.Direction;
        window.ParentType = enums_2.ParentType;
        window.BodyType = enums_2.BodyType;
    }
});
...
(function (dependencies, factory) {
    ...
    class Body {
        ...
        set entity(val) { console.log("[ERROR] can't set entity"); }
        get _topEntity() { return this._entity._topEntity; }
        ...
        get x() { return this._x - this._topEntity.globalx + this._entity.globalx; }
        get y() { return this._y - this._topEntity.globaly + this._entity.globaly; }
        get globalx() { return this._x + this._topEntity.globalx; }
        get globaly() { return this._y + this._topEntity.globaly; }
        set x(val) {
            let x = val, topEntity = this._entity;
            while (topEntity != this._topEntity) {
                x += topEntity._x;
        ...
        set globalx(val) { this._topx = val - this._topEntity.globalx; }
        set globaly(val) { this._topy = val - this._topEntity.globaly; }
        get contacts() {
        ...
        _clearContacts() {
            ...
            if (remove)
                this._topEntity._removeLowers(remove);
            if (this._higherContacts) {
                ...
                for (let higher of this._higherContacts) {
                    ...
                    if (higher.body._entity._listener && higher.body._entity._listener.contactEnd) {
                        higher.body._entity._listener.contactEnd(higher.body, higher.otherBody, higher.side == 0 ? "right" : (higher.side == 1 ? "left" : (higher.side == 2 ? "up" : "down")));
                    }
                }
        ...
        _resetBounds() {
            ...
            if (top._allBodies) {
                ...
                top._bodies.updateAABB(this);
            }
        }
        _enabledChangeContactFix() {
            let topEntity = this._topEntity, remove;
            ...
            if (remove)
                topEntity._removeLowers(remove);
            if (this._higherContacts) {
                for (let i = 0, len = this._higherContacts.length; i < len; i++) {
                    ...
                    if (higher.body._topEntity._listener && higher.body._topEntity._listener.contactEnd) {
                        higher.body._topEntity._listener.contactEnd(higher.body, higher.otherBody, higher.side == 0 ? "right" : (higher.side == 1 ? "left" : (higher.side == 2 ? "up" : "down")));
                    }
                }
    ...
    class SmallBody extends Body {
        ...
        get layer() { return this._topEntity._world._layerNames[this._layer]; }
        get layerGroup() { return this._layerGroup; }
        set isSensor(val) {
            if (val != this._isSensor) {
                this._isSensor = val;
                if (val)
                    this._isSensorChangeContactFix();
            }
        }
        set layer(val) {
                ...
                if (lower.body == this) {
                    ...
                    switch (this._entity._world._getLayerRule(lower.body._layer, lower.otherBody._layer)) {
                        case 0x0:
                            ...
                            break;
                        case 0x1:
                            removed = lower.body._layerGroup == lower.otherBody._layerGroup;
                            break;
                        case 0x2:
                            removed = lower.body._layerGroup != lower.otherBody._layerGroup;
                            break;
                ...
                for (let i = 0, len = this._higherContacts.length; i < len; i++) {
                    ...
                    switch (this._entity._world._getLayerRule(higher.body._layer, higher.otherBody._layer)) {
                        case 0x0:
                            ...
                            break;
                        case 0x1:
                            removed = higher.body._layerGroup == higher.otherBody._layerGroup;
                            break;
                        case 0x2:
                            removed = higher.body._layerGroup != higher.otherBody._layerGroup;
                            break;
    ...
    class Rect extends SmallBody {
        constructor(entity, args) {
            super(entity, args);
            this.type = enums_1.BodyType.RECT;
            if (args) {
        ...
        get minX() { return this._x - this._width / 2; }
        get maxX() { return this._x + this._width / 2; }
        get minY() { return this._y - this._height / 2; }
        get maxY() { return this._y + this._height / 2; }
        get _leftCollide() { return true; }
        get _rightCollide() { return true; }
        get _upCollide() { return true; }
        get _downCollide() { return true; }
    }
    exports.Rect = Rect;
    class Line extends SmallBody {
        constructor(entity, args) {
            super(entity, args);
            this.type = enums_1.BodyType.LINE;
            if (args) {
        ...
        get isVertical() { return !this._isHorizontal; }
        set isHorizontal(val) { console.log("[ERROR] Can't set Line.isHorizontal"); }
        set isVertical(val) { console.log("[ERROR] Can't set Line.isVertical"); }
        get side() {
        ...
        get minX() { return this._x - (this._isHorizontal && this._size / 2); }
        get maxX() { return this._x + (this._isHorizontal && this._size / 2); }
        get minY() { return this._y - (!this._isHorizontal && this._size / 2); }
        get maxY() { return this._y + (!this._isHorizontal && this._size / 2); }
        get _width() { return this._isHorizontal ? this._size : 0; }
        get _height() { return this._isHorizontal ? 0 : this._size; }
        set _width(val) { this._size = val; }
        set _height(val) { this._size = val; }
        get _leftCollide() { return this._oneway == 0 || !this._isHorizontal && this._oneway == 2; }
        get _rightCollide() { return this._oneway == 0 || !this._isHorizontal && this._oneway == 1; }
        get _upCollide() { return this._oneway == 0 || this._isHorizontal && this._oneway == 1; }
        get _downCollide() { return this._oneway == 0 || this._isHorizontal && this._oneway == 2; }
    }
    exports.Line = Line;
    ...
    exports.EMPTY = 0;
    exports.BLOCK_TILE = 1;
    exports.UP_ONEWAY = 4;
    exports.DOWN_ONEWAY = 2;
    exports.LEFT_ONEWAY = 3;
    exports.RIGHT_ONEWAY = 5;
    class Grid extends Body {
        constructor(entity, args) {
            super(entity, args);
            this.type = enums_1.BodyType.GRID;
            ...
            if (args.tiles != null) {
                if (args.tiles.length != null) {
                    minx = args.tiles[0].x;
                    miny = args.tiles[0].y;
                    maxx = args.tiles[0].x;
                    maxy = args.tiles[0].y;
                    for (let tile of args.tiles) {
            ...
            if (args.tiles != null) {
                if (args.tiles.length != null) {
                    let len = args.tiles.length;
                    for (let t of args.tiles) {
                        this._setTile(t.x - this._xdownLeft, t.y - this._ydownLeft, t.shape, t.data);
                    }
                }
                else {
                    this._setTiles(args.tiles.x - this._xdownLeft, args.tiles.y - this._ydownLeft, args.tiles.info.length, args.tiles.info[0].length, (x, y) => args.tiles.info[x - args.tiles.x][y - args.tiles.y]);
                }
            }
        }
        get minX() { console.log('Grid.minx not implemented'); return 0; }
        get maxX() { console.log('Grid.maxx not implemented'); return 0; }
        get minY() { console.log('Grid.miny not implemented'); return 0; }
        get maxY() { console.log('Grid.maxy not implemented'); return 0; }
        ...
        setBlocks(args) {
            let minx, maxx, miny, maxy, list = args.length != null;
            if (list) {
                let t = args;
                if (!t.length) {
                    return;
            ...
            if (list) {
                ...
                this._setTiles(minx, miny, args.info.length, args.info[0].length, (x, y) => {
                    return args.info[x - args.x][y - args.y];
                });
            }
        }
        clearBlocks(args) {
        ...
        forBlocks(x, y, width, height, lambda) {
            this._expandGrid(x - this._xdownLeft, y - this._ydownLeft, x + width - this._xdownLeft, y + height - this._ydownLeft);
            this._setTiles(x - this._xdownLeft, y - this._ydownLeft, width, height, (xx, yy, shape, data) => lambda(xx, yy, shape, data));
        }
        getBlockShape(x, y) {
            return this.getBlock(x, y).shape;
        }
        setBlockShape(x, y, shape) {
            this._expandGrid(x - this._xdownLeft, y - this._ydownLeft, x - this._xdownLeft, y - this._ydownLeft);
            x -= this._xdownLeft;
            y -= this._ydownLeft;
        ...
        clearBlockShapes(args) {
            this._clearTiles(args, 0);
        }
        _clearTiles(args, zero) {
            if (args.length != null) {
                ...
                let x = Math.max(0, args.x - this._xdownLeft), y = Math.max(0, args.y - this._ydownLeft);
                args.width = Math.min(this._width * this._gridSize, args.x + args.width) - x - this._xdownLeft;
                args.height = Math.min(this._height * this._gridSize, args.y + args.height) - y - this._ydownLeft;
                if (args.width > 0 && args.height > 0) {
                    this._setTiles(x, y, args.width, args.height, (x, y) => zero);
                }
            }
        }
        _horizontalBodyMerge(subgrid, tile, oldBody, x, y, xoffset, yoffset) {
            if (tile.shape == 1 || tile.shape == 2 || tile.shape == 4) {
                let body;
                if (x < this._gridSize - 1) {
                    let rightTile = subgrid.tiles[x + 1][y], rightBody = rightTile.body;
        ...
        _verticalBodyMerge(subgrid, tile, oldBody, x, y, xoffset, yoffset) {
        ...
        _removeBody(subgrid, tile, x, y, xoffset, yoffset) {
            ...
            if (oldBody) {
                if (oldBody._width == 1) {
                    if (oldBody._height == 1) {
                        ...
                        oldBody._y += 0.5;
                        if (oldBody._height == 1)
                            this._horizontalBodyMerge(subgrid, subgrid.tiles[x][y + 1], oldBody, x, y + 1, xoffset, yoffset);
                        ...
                        if (tile.shape == 1) {
                            ...
                            newBody._size = y + yoffset - oldBody._y + oldBody._size / 2;
                            newBody._isHorizontal = false;
                            newBody._y = y - newBody._size / 2 + yoffset;
                            if (tile.shape == 3) {
                                newBody._oneway = 2;
                                newBody._x = x + xoffset;
                            }
                            else {
                                newBody._oneway = 1;
                                newBody._x = x + xoffset + 1;
                            }
                            oldBody._size -= newBody._size + 1;
                            oldBody._y += (newBody._size + 1) / 2;
                        }
                        ...
                        // together
                        if (newBody._height == 1)
                            this._horizontalBodyMerge(subgrid, subgrid.tiles[x][y - 1], newBody, x, y - 1, xoffset, yoffset);
                        if (oldBody._height == 1)
                            this._horizontalBodyMerge(subgrid, subgrid.tiles[x][y + 1], oldBody, x, y + 1, xoffset, yoffset);
                    }
                }
                    ...
                    if (x + xoffset == oldBody._x - oldBody._width / 2) {
                        ...
                        oldBody._x += 0.5;
                        if (oldBody._width == 1)
                            this._verticalBodyMerge(subgrid, subgrid.tiles[x + 1][y], oldBody, x + 1, y, xoffset, yoffset);
                        this._updatedBodies.push(oldBody);
                    }
                        ...
                        if (tile.shape == 1) {
                            ...
                            newBody = new Line(null, null);
                            newBody._size = x + xoffset - oldBody._x + oldBody._size / 2;
                            newBody._isHorizontal = true;
                            newBody._x = x - newBody._size / 2 + xoffset;
                            if (tile.shape == 2) {
                                newBody._oneway = 2;
                        ...
                        newBody._isSensor = false;
                        this._newBodies.push(newBody);
                        if (this._newBodies.indexOf(oldBody) < 0)
                            this._updatedBodies.push(oldBody);
                        ...
                        // together
                        if (newBody._width == 1)
                            this._verticalBodyMerge(subgrid, subgrid.tiles[x - 1][y], newBody, x - 1, y, xoffset, yoffset);
                        if (oldBody._width == 1)
                            this._verticalBodyMerge(subgrid, subgrid.tiles[x + 1][y], oldBody, x + 1, y, xoffset, yoffset);
                    }
                }
        ...
        _updateTileBody(subgrid, tile, x, y, xoffset, yoffset, shape, layer, layerGroup) {
            // REMOVE CURRENTLY PRESENT BODY
            this._removeBody(subgrid, tile, x, y, xoffset, yoffset);
            // TRY TO EXTEND EXISTING ADJACENT BODIES
            let left = x > 0 && subgrid.tiles[x - 1][y], right = x < this._gridSize - 1 && subgrid.tiles[x + 1][y], up = y < this._gridSize - 1 && subgrid.tiles[x][y + 1], down = y > 0 && subgrid.tiles[x][y - 1];
            if (shape > 1 || shape == 1
            ...
            if (shape == 1) {
                if (left && left.shape == 1 && left.layerGroup == layerGroup && left.layer == layer) {
                    if (x > 1 && y > 0 && y < this._gridSize - 1) {
                        let leftTile = subgrid.tiles[x - 2][y], upTile = subgrid.tiles[x - 1][y + 1], downTile = subgrid.tiles[x - 1][y - 1];
                ...
                if (right && right.shape == 1 && right.layerGroup == layerGroup && right.layer == layer) {
                    if (x < this._gridSize - 2 && y > 0 && y < this._gridSize - 1) {
                        let rightTile = subgrid.tiles[x + 2][y], upTile = subgrid.tiles[x - 1][y + 1], downTile = subgrid.tiles[x - 1][y - 1];
                ...
                if (up && up.shape == 1 && up.layerGroup == layerGroup && up.layer == layer) {
                    if (x > 1 && x < this._gridSize - 1 && y < this._gridSize - 2) {
                        let leftTile = subgrid.tiles[x - 1][y + 1], upTile = subgrid.tiles[x][y + 2], rightTile = subgrid.tiles[x + 1][y + 1];
                        if (leftTile.shape == 1 && leftTile.layer == layer && leftTile.layerGroup == layerGroup
                            && upTile.shape == 1 && upTile.layer == layer && upTile.layerGroup == layerGroup
                ...
                if (down && down.shape == 1 && down.layerGroup == layerGroup && down.layer == layer) {
                    if (x < this._gridSize - 1 && x > 0 && y > 1) {
                        let rightTile = subgrid.tiles[x + 1][y - 1], leftTile = subgrid.tiles[x - 1][y - 1], downTile = subgrid.tiles[x][y - 2];
                        if (rightTile.shape == 1 && rightTile.layer == layer && rightTile.layerGroup == layerGroup
                ...
                if (up && up.shape == 1 && !up.body && y < this._gridSize - 2 && x > 0 && x < this._gridSize - 1) {
                    let rightTile = subgrid.tiles[x + 1][y + 1], leftTile = subgrid.tiles[x - 1][y + 1], upTile = subgrid.tiles[x][y + 2];
                    if (rightTile.body && rightTile.shape == 1 && rightTile.layer == layer && rightTile.layerGroup == layerGroup && rightTile.body._height == 1) {
                        rightTile.body._width += 1;
                        rightTile.body._x -= 0.5;
        ...
        _updateTileSensorBody(subgrid, tile, x, y, xoffset, yoffset, isSensor, sensorLayer, sensorLayerGroup) {
        ...
        _updateTileBodies(subgrid, tile, x, y, xoffset, yoffset, shape, data) {
            let newLayer = data && typeof data.layer != "undefined" ? this._entity.world._layerIds[data.layer] : tile.layer, newLayerGroup = data && typeof data.layerGroup != "undefined" ? data.layerGroup : tile.layerGroup, newIsSensor = data && typeof data.isSensor != "undefined" ? data.isSensor : tile.sensor, newIsSensorLayer = data && typeof data.sensorLayer != "undefined" ? data.sensorLayer : tile.sensorLayer, newIsSensorLayerGroup = data && typeof data.sensorLayerGroup != "undefined" ? data.sensorLayerGroup : tile.sensorLayerGroup;
        ...
        _setTile(x, y, shape, data) {
            ...
            if (this._subGrids instanceof SubGrid) {
                ...
                y -= gridy * this._gridSize;
                tile = subgrid.tiles[x][y];
                this._updateTileBodies(subgrid, tile, x, y, this._xdownLeft + gridx * this._gridSize, this._ydownLeft + gridy * this._gridSize, shape, data);
            }
            for (let b of this._oldBodies) {
                this._topEntity.removeBody(b);
            }
            for (let b of this._newBodies) {
                this._topEntity._addBody(b);
            }
        ...
        _setTiles(x, y, width, height, info) {
            let small = this._subGrids instanceof SubGrid;
            if (small) {
                this._newBodies = [];
                this._oldBodies = [];
                this._updatedBodies = [];
                this._setTilesInSubGrid(x, x + width, y, y + height, this._xdownLeft, this._ydownLeft, this._subGrids, (xx, yy, shape, data) => info(xx + this._xdownLeft, yy + this._ydownLeft, shape, data));
                for (let b of this._oldBodies) {
                    this._entity.removeBody(b);
                }
                for (let b of this._newBodies) {
                    this._entity._addBody(b);
                }
            }
            else {
                this._newBodies = [];
                this._oldBodies = [];
                let gridminx = Math.floor(x / this._gridSize), gridminy = Math.floor(y / this._gridSize), gridmaxx = Math.floor((x + width) / this._gridSize), gridmaxy = Math.floor((y + height) / this._gridSize);
                for (let gridx = gridminx; gridx <= gridmaxx; gridx++) {
                    for (let gridy = gridminy; gridy <= gridmaxy; gridy++) {
                        ...
                        this._setTilesInSubGrid(Math.max(0, x - xoff), Math.min(this._gridSize, x + width - xoff), Math.max(0, y - yoff), Math.min(this._gridSize, y + height - yoff), xoff2, yoff2, subgrid, (x, y, shape, data) => info(x + xoff2, y + yoff2, shape, data));
                    }
                }
                for (let b of this._oldBodies) {
                    this._entity.removeBody(b);
        ...
        _setTilesInSubGrid(minx, maxx, miny, maxy, xoffset, yoffset, subgrid, info) {
            for (let j = miny; j < maxy; j++) {
                for (let i = minx; i < maxx; i++) {
                    let tile = subgrid.tiles[i][j], res = info(i, j, tile.shape, tile.data);
                    if (res) {
        ...
        _expandGrid(minx, miny, maxx, maxy) {
            if (minx < 0 || miny < 0 || maxx >= this._gridSize * this._width || maxy >= this._gridSize * this._height) {
                let left = Math.max(Math.ceil(-minx / this._gridSize), 0), right = Math.max(Math.floor(maxx / this._gridSize) - this._width + 1, 0), up = Math.max(Math.floor(maxy / this._gridSize) - this._height + 1, 0), down = Math.max(Math.ceil(-miny / this._gridSize), 0);
...
(function (dependencies, factory) {
    ...
    const body_2 = require("./body");
    class Entity {
        constructor(world, args) {
            this._lowers = [];
            this._invalidOverlap = [];
            this._minX = Infinity;
            this._maxX = -Infinity;
            this._minY = Infinity;
            this._maxY = -Infinity;
            ...
            switch (args.type) {
                case null: {
                    ...
                    if (a.body) {
                        ...
                        if (a.bodies.length != null) {
                            for (let b of a.bodies) {
                                this._createBody(b);
                            }
                        }
                        else {
                            this._createBody(a.bodies);
                        }
                    }
                    break;
                }
        ...
        set world(val) { console.error("[ERROR] can't set Entity.world"); }
        get listener() { return this._listener; }
        set listener(val) { this._listener = val; }
        get destroyed() { return this._topEntity == null; }
        set destroyed(val) { console.error("[ERROR] can't set Entity.destroyed"); }
        // HIERARCHY
        get parent() { return this._parent; }
        set parent(val) { this._setParent(val, this._parentType); }
        get parentType() { return this._parentType == 0 ? "static" : "follow"; }
        set parentType(val) {
        ...
        get children() { return _.clone(this._childs); }
        set children(val) { console.error("[ERROR] can't set Entity.childs"); }
        get body() {
            if (this._grids) {
                if (this._grids instanceof body_2.Grid)
                    return this._grids;
                else
                ...
                if (this._bodies) {
                    if (this._bodies instanceof body_1.Body)
                        return this._bodies;
                    else
                        return null;
                }
        ...
        set body(val) { console.error("[ERROR] can't set Entity.body"); }
        get bodies() {
            if (this._bodies) {
                if (this._bodies instanceof body_1.Body) {
                    return [this._bodies];
        ...
        set bodies(val) { console.error("[ERROR] can't set Entity.bodies"); }
        get level() { return this._level; }
        set level(val) {
            if (!this._parent || this._parentType == 1)
        ...
        // POSITIONNING
        get x() { return this._x - (this._parent != null && this._parentType == 1 ? this._parent.globalx : 0); }
        get y() { return this._y - (this._parent != null && this._parentType == 1 ? this._parent.globaly : 0); }
        set x(val) { this.__x = val + (this._parent != null ? this._parent.globalx : 0); }
        set y(val) { this.__y = val + (this._parent != null ? this._parent.globaly : 0); }
        get globalx() { return this._x + (this._parent != null && this._parentType == 0 ? this._parent.globalx : 0); }
        get globaly() { return this._y + (this._parent != null && this._parentType == 0 ? this._parent.globaly : 0); }
        set globalx(val) { this.__x = val - (this._parent != null && this._parentType == 0 ? this._parent.globalx : 0); }
        set globaly(val) { this.__y = val - (this._parent != null && this._parentType == 0 ? this._parent.globaly : 0); }
        get globalvx() { return this._vx + (this._parent != null ? this._parent.globalvx : 0); }
        get globalvy() { return this._vy + (this._parent != null ? this._parent.globalvy : 0); }
        set globalvx(val) { this.vx = val - (this._parent != null ? this._parent.globalvx : 0); }
        set globalvy(val) { this.vy = val - (this._parent != null ? this._parent.globalvy : 0); }
        ...
        get contacts() {
            ...
            this._forAllBodies(b => {
                if (b._higherContacts) {
                    res.push.apply(res, b._higherContacts);
                }
            });
            for (let c of res) {
        ...
        get hasLeftContact() { return this._lowers.find(c => c.side == 1) != null; }
        get hasRightContact() { return this._lowers.find(c => c.side == 0) != null; }
        get hasUpContact() { return this._lowers.find(c => c.side == 2) != null; }
        get hasDownContact() { return this._lowers.find(c => c.side == 3) != null; }
        get isCrushed() { return this._invalidOverlap.length > 0; }
        get minX() { return this._minX + this._x; }
        get maxX() { return this._maxX + this._x; }
        get minY() { return this._minY + this._y; }
        get maxY() { return this._maxY + this._y; }
        // HIERARCHY
        createRect(args) {
            let body = new body_2.Rect(this, args);
            this._addBody(body);
            return body;
        }
        createLine(args) {
            let body = new body_2.Line(this, args);
            this._addBody(body);
            return body;
        }
        createGrid(args) {
            let body = new body_2.Grid(this, args);
            if (!this._grids) {
                this._grids = body;
            }
            else if (this._grids instanceof body_2.Grid) {
        ...
        removeBody(body) {
            ...
            if (topEntity._minX == body.minX) {
                topEntity._resetMinx();
            }
            if (topEntity._maxX == body.maxX) {
                topEntity._resetMaxx();
            }
            if (topEntity._minY == body.minY) {
                topEntity._resetMiny();
            }
            if (topEntity._maxY == body.maxY) {
                topEntity._resetMaxy();
            }
        }
        _createBody(args) {
            if (args.width != null) {
                this._addBody(new body_2.Rect(this, args));
            }
            else if (args.size != null) {
                this._addBody(new body_2.Line(this, args));
            }
            else {
                if (!this._grids) {
                    this._grids = new body_2.Grid(this, args);
                }
                else if (this._grids instanceof body_2.Grid) {
                    this._grids = [this._grids, new body_2.Grid(this, args)];
                }
                else {
                    this._grids.push(new body_2.Grid(this, args));
                }
            }
        }
        _addBody(body) {
            if (this._bodies != null) {
                if (this._bodies instanceof body_1.Body) {
                    ...
                    this._bodies = new binaryTree_1.BinaryTree();
        ...
        forBodies(lambda) {
            if (this._bodies) {
                if (this._bodies instanceof body_1.Body) {
                    ...
                    this._bodies.forAll(b => { if (!b._grid) {
                        lambda(b);
                    } });
                }
            }
        ...
        _setParent(parent, parentType, keepPosition) {
            // TODO: update bounds
            ...
            if (this._parent != parent) {
                ...
                if (this._parent) {
                    ...
                    if (this._parentType == 0) {
                        ...
                        let topEntity = this._parent, x = this._x, y = this._y;
                        ...
                        if (this._childs && this.children.filter(c => c._parentType == 0).length && !this._allBodies) {
                            this._allBodies = new binaryTree_1.BinaryTree();
                        ...
                        while (child) {
                            ...
                            if (remove)
                                _.pullAt(topEntity._lowers, remove);
                ...
                if (parent) {
                    ...
                    if (parentType == 0) {
                        let topEntity = parent, x = this._x, y = this._y;
                        while (topEntity._parent != null && topEntity._parentType == 0) {
                            x += topEntity._x;
                            y += topEntity._y;
                            topEntity = topEntity._parent;
                        ...
                        // IF HAS STATIC CHILD, NEEDS A VBH
                        if (!topEntity._allBodies) {
                            topEntity._allBodies = new binaryTree_1.BinaryTree();
        ...
        moveToGlobal(x, y) {
            this.move(x - this._x - (this._parent && this._parentType == 0 ? this._parent.globalx : 0), y - this._y - (this._parent && this._parentType == 0 ? this._parent.globaly : 0));
        }
        moveToLocal(x, y) {
            this.move(x - this.x + (this._parent && this._parentType == 1 ? this._parent.globalx : 0), y - this.y + (this._parent && this._parentType == 1 ? this._parent.globaly : 0));
        }
        localToGlobal(x, y) {
            if (typeof x !== "number") {
                y = x.y;
        ...
        _levelChangeContactFix(oldLevel, newLevel) {
        ...
        _removeLowers(indexes) {
            let contacts = _.pullAt(this._lowers, indexes);
            if (this._listener && this._listener.contactEnd) {
                for (let c of contacts) {
                    this._listener.contactEnd(c.body, c.otherBody, c.side == 0 ? "right" : (c.side == 1 ? "left" : c.side == 2 ? "up" : "down"));
                }
            }
        }
    }
...
(function (dependencies, factory) {
    ...
    var BodyType;
    (function (BodyType) {
        BodyType[BodyType["RECT"] = 0] = "RECT";
        BodyType[BodyType["LINE"] = 1] = "LINE";
        BodyType[BodyType["GRID"] = 2] = "GRID";
...
(function (dependencies, factory) {
    ...
    class World {
        constructor(userSpatialRegions) {
            ...
            if (userSpatialRegions) {
                this._vbh = new binaryTree_1.MoveBinaryTree();
            }
            else {
                this._vbh = new vbh_1.SimpleMoveVBH();
            }
        }
        // ##### TIME
        get time() { return this._time; }
        set time(val) { console.log("[ERROR] you can't change the time"); }
        get layers() { return Object.keys(this._layerIds).filter(l => l); }
        // ##### LAYER
        _getLayer(layer) {
        ...
        addLayer(layer) {
            ...
            if (i == 32) {
                console.log("[ERROR] Can't add layer: no more layers available" + null.a);
            }
            else {
        ...
        setLayerRule(layer1, layer2, rule) {
            ...
            let id1 = this._layerIds[layer1], id2 = this._layerIds[layer2];
            if (id2 >= 16) {
                let add, clear = ~(3 << (2 * id2 - 16));
                switch (rule) {
                    case enums_1.LayerCollisionRule.ALWAYS:
                        add = 3 << (2 * id2 - 16);
                        break;
                    case enums_1.LayerCollisionRule.EQUAL_GROUP:
                        add = 2 << (2 * id2 - 16);
                        break;
                    case enums_1.LayerCollisionRule.UNEQUAL_GROUP:
                        add = 1 << (2 * id2 - 16);
                        break;
                    case enums_1.LayerCollisionRule.NEVER:
                        add = 0;
                        break;
                }
        ...
        getLayerRule(layer1, layer2) {
            let id1 = this._layerIds[layer1], id2 = this._layerIds[layer2];
            switch (this._getLayerRule(id1, id2)) {
                case 0x3: return enums_1.LayerCollisionRule.ALWAYS;
                case 0x2: return enums_1.LayerCollisionRule.EQUAL_GROUP;
                case 0x1: return enums_1.LayerCollisionRule.UNEQUAL_GROUP;
                case 0: return enums_1.LayerCollisionRule.NEVER;
            }
        }
        // ##### ENTITIES
        createEntity(args) {
            let entity = new entity_1.Entity(this, args);
        ...
        _addTopEntity(entity) {
            this._vbh.insert(entity);
        }
        _removeTopEntity(entity) {
        ...
        queryRect(x, y, w, h) {
            ...
            for (let entity of entQuery) {
                if (entity._allBodies) {
                    ...
                    if (entity._bodies instanceof body_1.Body) {
        ...
        simulate(delta) {
            ...
            for (let level in this._ents) {
                ...
                for (let ent of currentEnts) {
                    let oldx = ent._x, oldy = ent._y, time = 0;
                    // INVALID STATE SOLVING
                    this._hasInvalidOverlap = false;
                    let hadOverlap = ent._invalidOverlap.length > 0;
                    this._newOverlap = null;
                    ent._invalidOverlap.forEach((o) => {
                        this._handleOverlap(ent, o, o[0], o[1], delta);
                    });
                    ent._potContacts.forEach((o) => {
                        if (this._newOverlap) {
                            let i = 0, len = this._newOverlap.length;
                            while (i < len && o[0] != this._newOverlap[i][0] && o[1] != this._newOverlap[i][1])
                                i++;
                            if (i == len)
                                this._handleOverlap(ent, o, o[0], o[1], delta);
                        }
                    ...
                    if (this._newOverlap)
                        ent._invalidOverlap = this._newOverlap;
                    else if (hadOverlap)
                        ent._invalidOverlap = [];
                    ...
                    while (!endOfCourse && a < 10) {
                        ...
                        if (ent._lowers.length) {
                            ...
                            while (push) {
                                ...
                                if (remove)
                                    ent._removeLowers(remove);
                            }
                        }
                        if (ent._potContacts.length > 0) {
                            // CALCULATE POTENTIAL COLLISION INFO
                            let narrows = ent._potContacts.map(pair => {
                                return this._narrowPhase(pair[0], pair[1], pair[0]._x + ent._x, pair[0]._y + ent._y, pair[1]._x + pair[1]._topEntity._x + pair[1]._topEntity._simvx * (time - delta), pair[1]._y + pair[1]._topEntity._y + pair[1]._topEntity._simvy * (time - delta), ent._vx, ent._vy, pair[1]._topEntity._simvx, pair[1]._topEntity._simvy, delta - time);
                            }).filter(n => n);
                            // DECIDE BEHAVIOUR
                            if (narrows.length > 0) {
                                // DEFINE NEW CONTACTS DUE TO COLLISIONS
                                let firstTime = Infinity, first;
                                ...
                                if (!first) {
                                    ...
                                    if (ent._listener && ent._listener.contactStart) {
                                        ent._listener.contactStart(newContact.body, newContact.otherBody, newContact.side == 0 ? "right" : (newContact.side == 1 ? "left" : (newContact.side == 2 ? "up" : "down")));
                                    }
                                }
                            }
                            else {
                                ...
                                switch (lower.side) {
                                    case 0: {
                                        if (Math.abs(lower.body._y + ent._y - lower.otherBody._y - lower.otherBody._topEntity._y) * 2
                                            > lower.body._height + lower.otherBody._height) {
                                            if (remove)
                                                remove.push(i);
                                            else
                                                remove = [i];
                                    ...
                                    case 2: {
                                        if (Math.abs(lower.body._x + ent._x - lower.otherBody._x - lower.otherBody._topEntity._x) * 2
                                            > lower.body._width + lower.otherBody._width) {
                                            if (remove)
                                                remove.push(i);
                                            else
                                                remove = [i];
                    ...
                    for (let pot of ent._potContacts) {
                        if (Math.abs(ent._x + pot[0]._x + pot[0]._width / 2 - pot[1]._topEntity._x - pot[1]._x + pot[1]._width / 2) < 0.000001
                            ...
                            ent._lowers.push(newContact);
                            if (pot[1]._higherContacts)
                                pot[1]._higherContacts.push(newContact);
                            else
                                pot[1]._higherContacts = [newContact];
                            if (ent._listener && ent._listener.contactStart) {
        ...
        _broadphase(delta) {
            ...
            for (let level in this._ents) {
                ...
                for (let e of ents) {
                    if (e._overlap)
                        e._overlap = e._overlap.filter((p) => {
            ...
            this._vbh.collisions() // CALCULATE ENTITY COLLISIONS
                ...
                if (e2._bodies instanceof body_1.SmallBody) {
                    if (e2.enabled) {
                        if (e1._bodies instanceof body_1.SmallBody) {
                            if (e1.enabled) {
                                overlapBodies.push([e1._bodies, e2._bodies]);
                            }
                        }
                        else {
                            let vbh = e1._allBodies || e1._bodies;
                            overlapBodies.push.apply(overlapBodies, vbh.collideAABB(e2._bodies, e1.globalx, e1.globaly, e1.globalvx, e1.globalvy, e2.globalx, e2.globaly + e2._bodies._y, e2.globalvx, e2.globalvy));
                        }
                    }
                }
                else {
                    if (e1._bodies instanceof body_1.SmallBody) {
                        if (e1._bodies.enabled) {
                            let vbh = e2._allBodies || e2._bodies;
                            overlapBodies.push.apply(overlapBodies, vbh.collideAABB(e1._bodies, e2.globalx, e2.globaly, e2.globalvx, e2.globalvy, e1.globalx, e1.globaly, e1.globalvx, e1.globalvy));
                        }
                    }
                    else {
                        let vbh1 = e2._allBodies || e2._bodies, vbh2 = e1._allBodies || e1._bodies;
                        overlapBodies.push.apply(overlapBodies, vbh1.collideVBH(vbh2, e2.globalx, e2.globaly, e2.globalvx, e2.globalvy, e1.globalx, e1.globaly, e1.globalvx, e1.globalvy));
                    }
                }
            });
            overlapBodies
                ...
                if (p[0]._isSensor || p[1]._isSensor) {
                    if (!p[0]._entity._overlap || !_.some(p[0]._entity._overlap, o => o[1] == p[1])) {
                        if (!(p[1]._topEntity._x + p[1]._x + p[1]._width / 2 < p[0]._topEntity._x + p[0]._x - p[0]._width / 2
                            ...
                            || p[1]._topEntity._y + p[1]._y + p[1]._height / 2 < p[0]._topEntity._y + p[0]._y - p[0]._height / 2
                            || p[1]._topEntity._y + p[1]._y - p[1]._height / 2 > p[0]._topEntity._y + p[0]._y + p[0]._height / 2)) {
                            if (!p[1]._entity._overlap) {
                                p[1]._entity._overlap = [];
                            }
                            if (!p[0]._entity._overlap) {
                                p[0]._entity._overlap = [];
                            }
                            p[0]._entity._overlap.push(p);
                            p[1]._entity._overlap.push([p[1], p[0]]);
                            if (p[0]._entity._listener && p[0]._entity._listener.overlapStart)
                                p[0]._entity._listener.overlapStart(p[0], p[1]);
                            if (p[1]._entity._listener && p[1]._entity._listener.overlapStart)
                                p[1]._entity._listener.overlapStart(p[1], p[0]);
                        }
                    }
                    return false;
                }
                    ...
                    if (!p[0]._entity._overlap || !_.some(p[0]._entity._overlap, o => o[1] == p[1])) {
                        if (!(p[1]._topEntity._x + p[1]._x + p[1]._width / 2 < p[0]._topEntity._x + p[0]._x - p[0]._width / 2
                            ...
                            if (p[0]._entity._listener && p[0]._entity._listener.overlapStart)
                                p[0]._entity._listener.overlapStart(p[0], p[1]);
                            if (p[1]._entity._listener && p[1]._entity._listener.overlapStart)
                                p[1]._entity._listener.overlapStart(p[0], p[1]);
                        }
                    }
                }
            });
        }
        _narrowPhase(b1, b2, x1, y1, x2, y2, vx1, vy1, vx2, vy2, delta) {
            ...
            if (toix > toiy) {
                if (toix < delta && toix > -0.0001) {
                    let newy1 = y1 + toix * vy1, newy2 = y2 + toix * vy2;
                ...
                if (toiy < delta && toiy > -0.0001) {
                    let newx1 = x1 + toiy * vx1, newx2 = x2 + toiy * vx2;
         ...
         *  5: move down
         */
        _solveOverlap(b1, b2, x1, y1, x2, y2, canUp, canDown, canLeft, canRight) {
            let up = y1 + b1._height / 2 - y2 - b2._height / 2, down = y2 - b2._height / 2 - y1 + b1._height / 2, left = x2 - b2._width / 2 - x1 + b1._width / 2, right = x1 + b1._width / 2 - x2 - b2._width / 2, yMax = Math.max(up, down), xMax = Math.max(left, right);
            if (yMax <= 0 && xMax <= 0) {
                if (canUp)
                    return 4;
                if (canDown)
        ...
        _handleOverlap(ent, pair, o1, o2, delta) {
            let otherx = o2._topEntity._x + o2._x - delta * o2._topEntity._simvx, othery = o2._topEntity._y + o2._y - delta * o2._topEntity._simvy;
            if (ent._x + o1._x - o1._width / 2 + 0.001 <= otherx + o2._width / 2
                ...
                && (o1 instanceof body_1.Rect || o1._oneway == 0)
                && (o2 instanceof body_1.Rect || o2._oneway == 0)) {
                switch (this._solveOverlap(o1, o2, ent._x + o1._x, ent._y + o1._y, otherx, othery, !ent._lowers.find(c => c.side == 2), !ent._lowers.find(c => c.side == 3), !ent._lowers.find(c => c.side == 1), !ent._lowers.find(c => c.side == 0))) {
                    case 1: {
                        if (this._newOverlap)
                    ...
                    case 2: {
                        ...
                        ent._lowers.push(newContact);
                        if (o2._higherContacts)
                            o2._higherContacts.push(newContact);
                        else
                            o2._higherContacts = [newContact];
                        if (ent._listener && ent._listener.contactStart)
                            ent._listener.contactStart(o1, o2, "right");
                        break;
                    }
                    case 3: {
                        ent._x = otherx + o2._width / 2 + o1._width / 2 - o1._x;
                        ...
                        if (o2._higherContacts)
                            ...
                            o2._higherContacts = [newContact];
                        if (ent._listener && ent._listener.contactStart)
                            ent._listener.contactStart(o1, o2, "left");
                        break;
                    }
                    case 4: {
                        ...
                        if (o2._higherContacts)
                            ...
                            o2._higherContacts = [newContact];
                        if (ent._listener && ent._listener.contactStart)
                            ent._listener.contactStart(o1, o2, "down");
                        break;
                    }
                    case 5: {
                        ent._y = othery - o2._height / 2 - o1._height / 2 - o1._y;
                        ...
                        if (o2._higherContacts)
                            ...
                            o2._higherContacts = [newContact];
                        if (ent._listener && ent._listener.contactStart)
                            ent._listener.contactStart(o1, o2, "up");
                        break;
                    }
                }
            }
...
(function (dependencies, factory) {
    ...
    class BinaryTree {
        constructor() {
            this._otherVBH = new vbh_1.SimpleVBH();
        }
        all() { return this._otherVBH.all(); }
        forAll(lambda) { this._otherVBH.forAll(lambda); }
        // MODIFICATION
        insert(e) {
        ...
        queryRect(x, y, width, height) {
            return this._queryRect(x - width / 2, x + width / 2, y - height / 2, y + height / 2);
        }
        collideVBH(other, x, y, dx, dy, otherx, othery, otherdx, otherdy) {
            if (other instanceof vbh_1.SimpleVBH) {
                return this._collideWithSimpleVBH(other, x, y, dx, dy, otherx, othery, otherdx, otherdy);
            }
            else {
                return this._collideWithBinaryTree(other, x, y, dx, dy, otherx, othery, otherdx, otherdy);
            }
        }
        collideAABB(o, x, y, dx, dy, otherx, othery, otherdx, otherdy) {
            let result = [];
            otherx -= x;
            othery -= y;
            otherdx -= dx;
            otherdy -= dy;
            let maxxOffset = o.maxX + otherx + Math.max(0, otherdx) * 2, minxOffset = o.minX + otherx + Math.min(0, otherdx) * 2, maxyOffset = o.maxY + othery + Math.max(0, otherdy) * 2, minyOffset = o.minY + othery + Math.min(0, otherdy) * 2;
        ...
        _queryRect(minX, maxX, minY, maxY) {
            let node = this._data;
        ...
        _queryRectCollisions(other, minX, maxX, minY, maxY) {
            let node = this._data;
            if (node && node.maxX >= minX && node.maxY >= minY && node.minX <= maxX && node.minY <= maxY) {
                let search = [], result = [];
                while (node) {
        ...
        _collideWithSimpleVBH(other, x, y, dx, dy, otherx, othery, otherdx, otherdy) {
            let result = [];
            otherx -= x;
            othery -= y;
            otherdx -= dx;
            otherdy -= dy;
            let maxxOffset = otherx + Math.max(0, otherdx) * 2, minxOffset = otherx + Math.min(0, otherdx) * 2, maxyOffset = othery + Math.max(0, otherdy) * 2, minyOffset = othery + Math.min(0, otherdy) * 2;
        ...
        _collideWithBinaryTree(other, x, y, dx, dy, otherx, othery, otherdx, otherdy) {
        ...
        _findMovePair(f, s, maxxOffset, maxyOffset, minxOffset, minyOffset, result) {
        ...
        _insert(e, aabb) {
            ...
            if (node)
                ...
                this._data = createLeafNode(null, e, e);
        }
        _insertInNode(node, e, aabb) {
            if (!aabb) {
                aabb = tmpAABB;
                tmpAABB.minX = e.minX;
                tmpAABB.maxX = e.maxX;
            ...
            node.right = createLeafNode(node, node.element, node);
            node.left = createLeafNode(node, e, aabb);
            node.element = null;
            while (node) {
                node.height++;
                extend(node, aabb);
        ...
        _remove(e) {
            let leaf = e.parentNode;
            if (!leaf.parent) {
                this._data = null;
            }
            else {
                let parent = leaf.parent, parentParent = parent.parent;
                if (parentParent) {
                    if (leaf == parent.left) {
    ...
    class MoveBinaryTree extends BinaryTree {
        collisions() {
            // updateCount++
        ...
        collisionSingle(e) {
            ...
            let search = [], result = [], node = this._data;
            while (node) {
    ...
    exports.MoveBinaryTree = MoveBinaryTree;
    function createNode(parent, left, right) {
        return {
            parent,
    ...
    function createLeafNode(parent, e, aabb) {
        let node = {
            parent,
            left: null,
            right: null,
...
(function (dependencies, factory) {
    ...
    class SimpleVBH {
        ...
        queryRect(x, y, width, height) {
            ...
            for (let e of this.elements) {
                if (e.enabled && e.minX <= x + width / 2 && e.maxX >= x - width / 2 && e.minY <= y + height / 2 && e.maxY >= y - height / 2) {
                    res.push(e);
                }
            }
            return res;
        ...
        collideVBH(other, x, y, dx, dy, otherx, othery, otherdx, otherdy) {
            if (other instanceof SimpleVBH) {
                ...
                return other._collideWithSimpleVBH(this, otherx, othery, otherdx, otherdy, x, y, dx, dy);
            }
        }
        collideAABB(other, x, y, dx, dy, otherx, othery, otherdx, otherdy) {
            let res = [];
            otherx -= x;
            othery -= y;
            otherdx -= dx;
            otherdy -= dy;
            let maxxOffset = other.maxX + otherx + Math.max(0, otherdx) * 2, minxOffset = other.minX + otherx + Math.min(0, otherdx) * 2, maxyOffset = other.maxY + othery + Math.max(0, otherdy) * 2, minyOffset = other.minY + othery + Math.min(0, otherdy) * 2;
    ...
    class SimpleMoveVBH extends SimpleVBH {
        collisions() {
            let res = [];
...
(function (dependencies, factory) {
    ...
    const binaryTree_1 = require("../lib/vbh/binaryTree");
    class Testbed {
        constructor() {
            this.xCam = 0;
            this.yCam = 0;
            ...
            let dpr = window.devicePixelRatio || 1, bsr = this.ctx.webkitBackingStorePixelRatio ||
                ...
                this.ctx.backingStorePixelRatio || 1, ratio = dpr / bsr;
            ...
            this.resetKeys();
            // BUTTONS 
            let playBtn = document.getElementById("play-btn"), stepBtn = document.getElementById("step-btn"), resetBtn = document.getElementById("reset-btn"), resetPauseBtn = document.getElementById("reset-pause-btn");
            playBtn.onclick = () => {
                if (this._play) {
                    this.pause();
        ...
        addScript(script) {
            if (!this.scripts.has(script.category)) {
                this.scripts.set(script.category, new Map());
            }
        ...
        start(script, paused) {
            ...
            this.world = new lib_1.World(this.useRBush);
        ...
        _draw() {
            ...
            if (this.world._vbh instanceof binaryTree_1.BinaryTree && this.showBroadphaseStructure) {
                let list = [], node = this.world._vbh._data;
                this.ctx.strokeStyle = "#00FF00";
                while (node) {
                    this.ctx.strokeRect(node.minX * this.zoom + bx, -node.maxY * this.zoom + by, (node.maxX - node.minX) * this.zoom, (node.maxY - node.minY) * this.zoom);
                    if (!node.element)
            ...
            if (this.zoom)
                for (let e of this.world._vbh.queryRect(this.xCam, this.yCam, this.canvas.width / this.zoom, this.canvas.height / this.zoom)) {
                    if (this.showEntity) {
                        ...
                        this.ctx.beginPath();
                        this.ctx.moveTo((x - 0.1) * this.zoom + bx, -(y - 0.1) * this.zoom + by);
                        this.ctx.lineTo((x + 0.1) * this.zoom + bx, -(y + 0.1) * this.zoom + by);
                        this.ctx.moveTo((x + 0.1) * this.zoom + bx, -(y - 0.1) * this.zoom + by);
                        this.ctx.lineTo((x - 0.1) * this.zoom + bx, -(y + 0.1) * this.zoom + by);
                        this.ctx.fillText((e.name || "") + " [" + x.toFixed(2) + ", " + y.toFixed(2) + "]", (x + 0.2) * this.zoom + bx, -y * this.zoom + by);
                        this.ctx.stroke();
                    }
                    if (this.showBroadphaseStructure && e._bodies && e._bodies instanceof binaryTree_1.BinaryTree) {
                        let list = [], node = e._bodies._data;
                        this.ctx.strokeStyle = "#00FFFF";
                        while (node) {
                            this.ctx.strokeRect((e._x + node.minX) * this.zoom + bx, -(e._y + node.maxY) * this.zoom + by, (node.maxX - node.minX) * this.zoom, (node.maxY - node.minY) * this.zoom);
                            if (!node.element)
                                list.push(node.left, node.right);
                            node = list.pop();
                        }
                    ...
                    if (this.showContact) {
                        ...
                        for (let lower of e._lowers) {
                            ...
                            this.ctx.stroke();
                            this.ctx.fillText(lower.side == 0 ? "right" : (lower.side == 1 ? "left" : (lower.side == 2 ? "up" : "down")), (lower.body.globalx + lower.otherBody.globalx) * this.zoom / 2 + bx, -(lower.body.globaly + lower.otherBody.globaly) * this.zoom / 2 + by);
                        }
                    ...
                    if (e._allBodies) {
                        ...
                        if (e._bodies instanceof lib_1.Body) {
                            bodies = [e._bodies];
                        }
                        else {
                    ...
                    bodies.forEach(b => {
                        ...
                        switch (b.type) {
                            case lib_1.BodyType.RECT: {
                                this.ctx.strokeRect((x - b.width / 2) * this.zoom + bx, (-b.height / 2 - y) * this.zoom + by, b.width * this.zoom, b.height * this.zoom);
                                break;
                            }
                            case lib_1.BodyType.LINE: {
                                if (b instanceof lib_1.Line) {
                                    if (b.isHorizontal) {
                                        this.ctx.beginPath();
                                        this.ctx.moveTo((x - b.size / 2) * this.zoom + bx, -y * this.zoom + by);
                                        this.ctx.lineTo((x + b.size / 2) * this.zoom + bx, -y * this.zoom + by);
                                        this.ctx.stroke();
                                        if (b.side == "up") {
                                            this.ctx.beginPath();
                                            this.ctx.moveTo((x - b.size / 2) * this.zoom + bx + 5, -y * this.zoom + by + 5);
                                            this.ctx.lineTo((x + b.size / 2) * this.zoom + bx - 5, -y * this.zoom + by + 5);
                                            this.ctx.stroke();
                                        }
                                        else if (b.side == "down") {
                                            this.ctx.beginPath();
                                        ...
                                        this.ctx.beginPath();
                                        this.ctx.moveTo(x * this.zoom + bx, (b.size / 2 - y) * this.zoom + by);
                                        this.ctx.lineTo(x * this.zoom + bx, (-b.size / 2 - y) * this.zoom + by);
                                        this.ctx.stroke();
                                        if (b.side == "left") {
                                            this.ctx.beginPath();
                                            this.ctx.moveTo(x * this.zoom + bx + 5, (b.size / 2 - y) * this.zoom + by - 5);
                                            this.ctx.lineTo(x * this.zoom + bx + 5, (-b.size / 2 - y) * this.zoom + by + 5);
                                            this.ctx.stroke();
                                        }
            ...
            this.ctx.font = "15px Arial";
            let d = this.scriptDescriptor.description, begin = 0, row = 0;
            if (d) {
                while (begin != -1) {
                    let br = d.indexOf('\n', begin);
                    if (br == -1) {
    ...
    window.onload = () => {
        ...
        testbed.addScript(gridScripts_1.GridScript4);
        testbed.addScript(gridScripts_1.GridScript5);
        testbed.addScript(gridScripts_1.GridScript6);
        testbed.addScript(simulScripts_1.SimulScript1);
        testbed.addScript(simulScripts_1.SimulScript2);
        testbed.addScript(simulScripts_1.SimulScript3);
        testbed.addScript(simulScripts_1.SimulScript4);
        testbed.addScript(simulScripts_1.SimulScript5);
        testbed.addScript(simulScripts_1.SimulScript6);
        testbed.addScript(simulScripts_1.SimulScript7);
        testbed.addScript(simulScripts_1.SimulScript8);
        testbed.addScript(simulScripts_1.SimulScript9);
        testbed.addScript(simulScripts_1.SimulScript10);
        testbed.addScript(simulScripts_1.SimulScript11);
...
(function (dependencies, factory) {
    ...
    class Script5 extends script_1.Script {
        init() {
            ...
            this.grid.setBlockShape(-2, 0, lib_1.UP_ONEWAY);
            this.grid.setBlockShape(-2, 1, lib_1.LEFT_ONEWAY);
            this.grid.setBlockShape(-2, 2, lib_1.RIGHT_ONEWAY);
            this.grid.setBlockShape(-2, 3, lib_1.DOWN_ONEWAY);
            this.grid.setBlockShape(-1, 3, lib_1.DOWN_ONEWAY);
            this.grid.setBlockShape(-3, 3, lib_1.DOWN_ONEWAY);
            this.grid.setBlockShape(-2, 3, lib_1.RIGHT_ONEWAY);
        }
        update(time, delta) {
        }
    }
    ...
    exports.GridScript1 = { id: "GridScript1", category: "Grid generation", name: "Grid script 1", description: null, script: () => new Script1() };
    exports.GridScript2 = { id: "GridScript2", category: "Grid generation", name: "Grid script 2", description: null, script: () => new Script2() };
    exports.GridScript3 = { id: "GridScript3", category: "Grid generation", name: "Grid script 3", description: null, script: () => new Script3() };
    exports.GridScript4 = { id: "GridScript4", category: "Grid generation", name: "Grid script 4", description: null, script: () => new Script4() };
    exports.GridScript5 = { id: "GridScript5", category: "Grid generation", name: "Grid script 5", description: null, script: () => new Script5() };
...
(function (dependencies, factory) {
    ...
    class Script5 extends script_1.Script {
        init() {
            this.world.setLayerRule("rect", "ground1", lib_1.LayerCollisionRule.ALWAYS);
    ...
    exports.SimulScript4 = { id: "SimulScript4", category: "Specification", name: "Test 4: Free rect movement against lines", description: "Move: ZQSD", script: () => new Script4() };
    exports.SimulScript5 = { id: "SimulScript5", category: "Specification", name: "Test 5: Layers and layer groups", description: "Move: ZQSD", script: () => new Script5() };
    exports.SimulScript6 = { id: "SimulScript6", category: "Specification", name: "Test 6: Free rect movement against several rects", description: "Move: ZQSD", script: () => new Script6() };
    exports.SimulScript7 = { id: "SimulScript7", category: "Specification", name: "Test 7: Free rect movement against multi-body entity", description: "Move: ZQSD", script: () => new Script7() };
    exports.SimulScript8 = { id: "SimulScript8", category: "Specification", name: "Test 8: Multi-body entity against multi-body entity", description: "Move: ZQSD", script: () => new Script8() };
    exports.SimulScript9 = { id: "SimulScript9", category: "Specification", name: "Test 9: Free rect movement against grid", description: "Move: ZQSD", script: () => new Script9() };
    exports.SimulScript10 = { id: "SimulScript10", category: "Specification", name: "Test 10: Grid against grid", description: "Move: ZQSD", script: () => new Script10() };
    exports.SimulScript11 = { id: "SimulScript11", category: "Specification", name: "Test 11: Grids and a character", description: "Move chararacter: ZQSD\nMove moving grid: TFGH", script: () => new Script11() };
